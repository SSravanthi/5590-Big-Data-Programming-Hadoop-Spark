...
object Task1 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val trip_data = spark.read
      ...
      .load("/Users/Sravanthi Somalaraju/Documents/Bigdata ICPs/Module2/ICP5/Source code/SparkGraphframe/SparkGraphframe/Datasets/Datasets/201508_trip_data.csv")

    val station_data = spark.read
      .format("csv")
      .option("header", "true") //reading the headers
      .option("mode", "DROPMALFORMED")
      .load("/Users/Sravanthi Somalaraju/Documents/Bigdata ICPs/Module2/ICP5/Source code/SparkGraphframe/SparkGraphframe/Datasets/Datasets/201508_station_data.csv")
...
// Bonus 2
    ...
    stationGraph.vertices.write.csv("/Users/Sravanthi Somalaraju/Documents/Bigdata ICPs/Module2/ICP5/Source code/SparkGraphframe/SparkGraphframe/Datasets/vertices")

    stationGraph.edges.write.csv("/Users/Sravanthi Somalaraju/Documents/Bigdata ICPs/Module2/ICP5/Source code/SparkGraphframe/SparkGraphframe/Datasets/edges")
