...
object Task2 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df1 = spark.read
      ...
      .load("/Users/anushakonakalla/Desktop/fifa-world-cup/WorldCups.csv")

    val df2 = spark.read
      .format("csv")
      .option("header", "true") //reading the headers
      .option("mode", "DROPMALFORMED")
      .load("/Users/anushakonakalla/Desktop/fifa-world-cup/WorldCupPlayers.csv")
    ...
    val df3 = spark.read
      ...
      .option("header", "true") //reading the headers
      .option("mode", "DROPMALFORMED")
      .load("/Users/anushakonakalla/Desktop/fifa-world-cup/WorldCupMatches.csv")
    ...
    val csv = sc.textFile("/Users/anushakonakalla/Desktop/fifa-world-cup/WorldCups.csv")
