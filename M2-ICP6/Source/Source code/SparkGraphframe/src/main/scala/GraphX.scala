...
object GraphX {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val trips_data = spark.read
      ...
      .load("/Users/Sravanthi Somalaraju/Documents/Bigdata ICPs/Module2/ICP6/Source code/SparkGraphframe/Datasets/201508_trip_data.csv")

    val station_data = spark.read
      .format("csv")
      .option("header", "true") //reading the headers
      .option("mode", "DROPMALFORMED")
      .load("/Users/Sravanthi Somalaraju/Documents/Bigdata ICPs/Module2/ICP6/Source code/SparkGraphframe/Datasets/201508_station_data.csv")
   ...
   //Label propagation algorithm LPA
    ...
    //Saving to File
    stationGraph.vertices.write.csv("/Users/Sravanthi Somalaraju/Documents/Bigdata ICPs/Module2/ICP6/Source code/SparkGraphframe/Datasets/vertices")
    stationGraph.edges.write.csv("/Users/Sravanthi Somalaraju/Documents/Bigdata ICPs/Module2/ICP6/Source code/SparkGraphframe/Datasets/edge")
